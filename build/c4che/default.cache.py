...
LIBDIR = '/Users/hans/.node_libraries'
LIBPATH_BOOST_THREAD = ['/opt/local/lib']
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_PORTMIDI = ['/Users/hans/portmedia/portmidi']
LIBPATH_ST = '-L%s'
LIB_BOOST_THREAD = ['boost_thread-mt']
LIB_PORTMIDI = ['portmidi']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/hans/.node_libraries'
PREFIX = '/usr/local'
